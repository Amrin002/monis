    ...
    <div class="space-y-6">
        ...
        <x-filament::section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                <div>
                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Hari</p>
                    <p class="text-base font-semibold">
                        @php
                            ...
                            $namaHari = \Carbon\Carbon::parse($tanggal)->format('l');
                            echo $hari[$namaHari] ?? $namaHari;
                        @endphp
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p class="text-base font-semibold">{{ $kelasInfo->nama ?? '-' }}</p>
                </div>

                <div>
                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Wali Kelas</p>
                    <p class="text-base font-semibold">{{ Auth::user()->guru->nama ?? '-' }}</p>
                </div>
            </div>
            ...
            {{-- ====================================================== --}}
            @php
                $stats = \App\Models\Absensi::whereHas('siswa.kelas', function ($query) {
                    $guru = Auth::user()->guru;
